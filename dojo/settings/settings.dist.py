...
HASHCODE_FIELDS_PER_SCANNER = {
    ...
    "Mend Scan": ["title", "severity", "description"],  # possible improvement: in the scanner put the library name into file_path, then dedup on vulnerability_ids + file_path + severity
    ...
    "Nexpose Scan": ["title", "severity", "vulnerability_ids", "cwe"],  # possible improvement: in the scanner put the library name into file_path, then dedup on cwe + file_path + severity
    ...
    "Symfony Security Check": ["title", "vulnerability_ids"],  # for backwards compatibility because someone decided to rename this scanner:
    ...
    "Yarn Audit Scan": ["title", "severity", "file_path", "vulnerability_ids", "cwe"],  # possible improvement: in the scanner put the library name into file_path, then dedup on cwe + file_path + severity
...
DEDUPLICATION_ALGORITHM_PER_PARSER = {
    ...
    "Veracode SourceClear Scan": DEDUPE_ALGO_HASH_CODE,  # for backwards compatibility because someone decided to rename this scanner:
